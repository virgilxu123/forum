<?php
    ...
    if(isset($_SESSION['signed_in']) && $_SESSION['signed_in'] == true){
        echo 'You are already signed in, you can <a href="signout.php">sign out
        </a> if you want.';
    }else {
        ...
        {
        /* so, the form has been posted, we'll process the data in three
        steps:
        1. Check the data
        ...
        */
        ...
        {
        echo '<li>' . $value . '</li>'; /* this generates a nice
        error list */
        }
        echo '</ul>';
        }
        ...
        users
        WHERE
        user_name = '" . mysql_real_escape_string
        ($_POST['user_name']) . "'
        AND
        ...
        echo 'Something went wrong while signing in. Please try
        again later.';
